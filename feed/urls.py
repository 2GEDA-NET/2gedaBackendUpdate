...
urlpatterns = [
    ...
    path('post/<int:post_id>/comment/<int:comment_id>/replies/', view_replies, name='view-replies'),
    path('post/<int:post_id>/comment/<int:comment_id>/replies/', create_reply, name='create-reply'),
