    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=250, validators=[django.core.validators.MinLengthValidator(7, message='Your password is too short! Minimum of 7 length is required')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('otp', models.CharField(blank=True, max_length=90, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_categories', models.ManyToManyField(blank=True, related_name='users_with_favorite', to='core.businesscategory')),
                ('media', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.profilemedia')),
            ],
        ),
        migrations.CreateModel(
            name='Verification',
