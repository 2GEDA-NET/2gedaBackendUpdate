    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_address', to='user.address')),
                ('cover_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_cover_image', to='user.profilemedia')),
                ('favorite_categories', models.ManyToManyField(blank=True, related_name='users_with_favorite', to='user.businesscategory')),
                ...
                ('searched_polls', models.ManyToManyField(blank=True, related_name='users_searched', to='poll.poll')),
